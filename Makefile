...
default:
	g++ -std=c++14 -O2 -I/usr/include/libxml2 -I/usr/include/lua$(LUA_VERSION) src/core/*.cpp src/core/parser/*.cpp src/core/instantiator/*.cpp src/core/instantiator/instantiators/*.cpp src/core/lua/*.cpp src/core/lua/api/*.cpp src/core/lua/api/entities/*.cpp src/core/iostream/*.cpp src/core/event/*.cpp src/core/event/triggers/*.cpp src/core/timer/*.cpp src/core/timer/jobs/*.cpp src/core/entities/*.cpp src/standalone/*.cpp src/standalone/actions/*.cpp -o trogdor -lxml2 -pthread -llua$(LUA_VERSION)

debug:
	g++ -std=c++14 -I/usr/include/libxml2 -I/usr/include/lua$(LUA_VERSION) -g src/core/*.cpp src/core/parser/*.cpp src/core/instantiator/*.cpp src/core/instantiator/instantiators/*.cpp src/core/lua/*.cpp src/core/lua/api/*.cpp src/core/lua/api/entities/*.cpp src/core/iostream/*.cpp src/core/event/*.cpp src/core/event/triggers/*.cpp src/core/timer/*.cpp src/core/timer/jobs/*.cpp src/core/entities/*.cpp src/standalone/*.cpp src/standalone/actions/*.cpp -o trogdor -pthread -lxml2 -llua$(LUA_VERSION)
...
freebsd:
	g++ -std=c++14 -O2 -I/usr/local/include -I/usr/local/include/lua$(subst .,,$(LUA_VERSION)) -I/usr/local/include/libxml2 -L/usr/local/lib src/core/*.cpp src/core/parser/*.cpp src/core/instantiator/*.cpp src/core/instantiator/instantiators/*.cpp src/core/lua/*.cpp src/core/lua/api/*.cpp src/core/lua/api/entities/*.cpp src/core/iostream/*.cpp src/core/event/*.cpp src/core/event/triggers/*.cpp src/core/timer/*.cpp src/core/timer/jobs/*.cpp src/core/entities/*.cpp -llua-$(LUA_VERSION) src/standalone/*.cpp src/standalone/actions/*.cpp -o trogdor -pthread -lxml2
